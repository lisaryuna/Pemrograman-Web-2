...
<div class="bg-white rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-100 p-8 max-w-2xl">
    <form action="/buku" method="POST" class="space-y-6">
        ...
        <div class="space-y-2">
            ...
            <div class="relative">
                <select id="kategori_id" name="kategori_id" class="appearance-none w-full pl-4 pr-10 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-soft-periwinkle/20 focus:border-soft-periwinkle transition-all cursor-pointer @error('kategori_id') border-red-400 @enderror">
