...
<div class="mb-8 flex items-center gap-4">
    ...
    <div>
        <h1 class="text-3xl font-bold text-gray-800">Edit Data Buku</h1>
        <p class="text-gray-500 mt-0.5 text-sm">Perbarui informasi detail buku ini di dalam sistem.</p>
    </div>
</div>

<div class="bg-white rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-100 p-8 max-w-2xl">
    <form action="{{ route('buku.update', $buku->buku_id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="space-y-2">
            ...
            <input type="number" id="tahun_terbit" name="tahun_terbit" value="{{ old('tahun_terbit', $buku->tahun_terbit) }}" min="1800" max="2026"
